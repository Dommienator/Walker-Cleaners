    ...
    <div style={styles.container}>
      ...
      <div style={styles.formSection}>
        <div style={styles.card}>
          ...
          <p style={styles.subtitle}>Fill in the details below and we'll get back to you shortly</p>
          ...
          <form style={styles.form} onSubmit={handleSubmit}>
            ...
            <div style={styles.formGroup}>
              <label style={styles.label}>
                Select {formData.type === 'service' ? 'Service' : 'Package'} <span style={styles.required}>*</span>
              </label>
              <select
